...
Polaris.Version = "v6.0" -- DONT TOUCH THIS! (if you change this the anticheat is not gonna work)
...
--// Default //--
Polaris.WeaponProtection = true -- Enable blacklisted weapons
Polaris.TriggersProtection = true -- Enable blacklisted events
Polaris.WordsProtection = false -- Enable blacklisted words
Polaris.GiveWeaponsProtection = true -- Enable give weapon
Polaris.ExplosionProtection = true -- Enable blacklisted explosions
Polaris.GiveWeaponAsPickupProtection = false -- Give Weapons as pickup
Polaris.DamageModifierDetection = true -- banning people that are trying to change damage scale
Polaris.DumpDetection = true -- banning people that trying to dump the server
Polaris.InvisibilityDetection = true -- people cant be invisible when this is enabled
Polaris.SpectateDetection = true -- banning people that trying to spectate
Polaris.PickupDetection = true -- deleting pickups like armor and med kits

Polaris.AntiBlips = true -- Detecting people that are trying to use player blips
Polaris.AntiSpectate = true -- Detecting people that are trying to spectate people
Polaris.AntiESX = false -- Only enable this on vrp servers!

--// Webhook //--
Polaris.LogWebhook = "WEBHOOK HERE" -- your webhook here.

--// License //--
Polaris.LicenseOwner = "CHANGE ME" -- the discord name of the person that bought the anticheat. (cannot be seen by other)

--// Custom //--
Polaris.ForceDiscord = false -- Forcing people to have fivem connected to discord (Highly Recommended because most of cheaters does not have fivem connected with discord)
Polaris.ForceDiscordMessage = "Discord is required to join this server."
Polaris.ForceDiscordConsoleLogs = true

Polaris.ForceSteam = false -- Forcing people to have steam open (Recommended for whitelisted servers)
Polaris.ForceSteamMessage = "Steam is required to join this server."
Polaris.ForceSteamConsoleLogs = true

Polaris.AntiVPN = false -- Detects if someone have VPN on. (Recommended for whitelisted servers)
Polaris.AntiVPNMessage = "VPN is not allowed on this server."
Polaris.AntiVPNDiscordLogs = true

Polaris.BanReason = "Hej din bøsse unge kan du stop med at bruge mod menu??" -- you can edit this uwu

Polaris.EjerToolBan = true -- for danish servers only.
 
Polaris.AntiAdminAbuse = false -- kicking admins that are trying to abuse their rank (only recommended for danish servers)
Polaris.AntiAdminAbuseKickMessage = "AntiAdminAbuse is enabled"

Polaris.MaxWeaponAmmo = 251 -- max weapon ammo

Polaris.DisableAllWeapons = false -- removing all weapons from players

Polaris.AntiVDM = false -- setting damage scale for vehicles to 0

Polaris.TeleportKick = false -- kicking people that are teleporting

Polaris.DisableAllUnits = false -- deleting all units on the server

--// ClearPedTasksImmediately //--
Polaris.ClearPedTasksImmediatelyDetection = true -- Automatically detect ClearPedTasksImmediately (detect cheaters that are kicking out of vehicles other players) NEW!
Polaris.ClearPedTasksImmediatelyKick = false -- kick
Polaris.ClearPedTasksImmediatelyBan = true -- ban

--// Resource Stuff //--
Polaris.ResourceStopDetection = true -- banning people that are trying to stop client sided resources

--// Blacklisted Commands //--
Polaris.BlacklistedCommands = {
    '//',
	'killmenu',
	'dd'
}
...
--// Blacklisted Models //--
Polaris.BlacklistedModels = { -- Peds/Vehicles
	--VEHICLES
	"RHINO",
	"KHANJALI",
	"HUNTER",
...
Polaris.WhitelistedProps = {
	"", -- does not work :/
}

--// Blacklisted Events //--
Polaris.BlacklistedEvents = {
